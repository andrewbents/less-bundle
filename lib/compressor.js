...
function compress(config, callback) {
    ...
    var src = path.resolve(globals.config.src), writers = globals.writers, output = globals.output, dest = globals.config.dest, version = globals.config.version, license = globals.config.license;
